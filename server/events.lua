...
RegisterNetEvent('QBCore:UpdatePlayer', function()
    ...
    local newHunger = Player.PlayerData.condition.hunger - QBCore.Config.Player.HungerRate
    local newThirst = Player.PlayerData.condition.thirst - QBCore.Config.Player.ThirstRate
    if newHunger <= 0 then
        newHunger = 0
    end
    if newThirst <= 0 then
    ...
    Player.Functions.SetThirst(newThirst)
    Player.Functions.SetHunger(newHunger)
