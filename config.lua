...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 1000, bank = 60000, crypto = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
QBConfig.Player = {}
QBConfig.Player.HungerRate = 3.0 -- Rate at which hunger goes down. per UpdateInterval
QBConfig.Player.ThirstRate = 2.6 -- Rate at which thirst goes down.
...
QBConfig.Server.CheckDuplicateLicense = GetConvar('qb_check_duplicate', 'true') == 'true' -- Check for duplicate rockstar license on join
