...
local Vehicles = {
    ...
    { model = 'comet7',        name = 'Comet',                         brand = 'S2 Cabrio',       price = 300000,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'dubsta2',       name = 'Dubsta pdm',                 brand = 'Benefactor',      price = 19500,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    ...
    { model = 'dominator4',    name = 'Dominator Arena',               brand = 'Vapid',           price = 200000,  category = 'muscle',         type = 'automobile', shop = 'none' },
    ...
    { model = 'dukes2',        name = 'Duke O\'Death',                 brand = 'Imponte',         price = 60000,   category = 'muscle',         type = 'automobile', shop = 'none' },
    ...
    --- Sports Classic (5)
    { model = 'ardent',        name = 'Ardent',                        brand = 'Ocelot',          price = 30000,   category = 'sportsclassics', type = 'automobile', shop = 'none' },
    ...
    { model = 'jb7002',        name = 'JB 700W',                       brand = 'Dewbauchee',      price = 40000,   category = 'sportsclassics', type = 'automobile', shop = 'none' },
    ...
    { model = 'stromberg',     name = 'Stromberg',                     brand = 'Ocelot',          price = 80000,   category = 'sportsclassics', type = 'automobile', shop = 'none' },
    ...
    { model = 'toreador',      name = 'Toreador',                      brand = 'Pegassi',         price = 50000,   category = 'sportsclassics', type = 'automobile', shop = 'none' },
    ...
    { model = 'kuruma2',       name = 'kuruma2',                       brand = 'Karin2',          price = 72000,   category = 'sports',         type = 'automobile', shop = 'none' },
    ...
    { model = 'caracara',      name = 'Caracara',                      brand = 'Vapid',           price = 60000,   category = 'offroad',        type = 'automobile', shop = 'none' },
    ...
    { model = 'utillitruck',   name = 'Utility Truck (Cherry Picker)', brand = 'Brute',           price = 30000,   category = 'utility',        type = 'automobile', shop = 'none' },
    { model = 'utillitruck2',  name = 'Utility Truck (Van)',           brand = 'Brute',           price = 30000,   category = 'utility',        type = 'automobile', shop = 'none' },
    { model = 'utillitruck3',  name = 'Utility Truck (Contender)',     brand = 'Vapid',           price = 30000,   category = 'utility',        type = 'automobile', shop = 'none' },
    ...
    { model = 'airtug',        name = 'Airtug',                        brand = 'HVY',             price = 30000,   category = 'utility',        type = 'automobile', shop = 'none' },
    --- Vans (12)
    ...
    --- Boats (14)
    { model = 'dinghy4',       name = 'Weaponized Dinghy',             brand = 'Nagasaki',        price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'none' },
    { model = 'avisa',         name = 'Avisa',                         brand = 'Kraken Subs',     price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'none' },
    { model = 'patrolboat',    name = 'Kurtz 31 Patrol Boat',          brand = 'Unknown',         price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'none' },
    { model = 'longfin',       name = 'Longfin',                       brand = 'Shitzu',          price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'tug',           name = 'Tug',                           brand = 'Buckingham',      price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'none' },
    { model = 'toro',          name = 'Toro',                          brand = 'Lampadati',       price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'toro2',         name = 'Toro Yacht',                    brand = 'Lampadati',       price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'submersible2',  name = 'Kraken',                        brand = 'Kraken Subs',     price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'none' },
    { model = 'speeder',       name = 'Speeder',                       brand = 'Pegassi',         price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'speeder2',      name = 'Speeder Yacht',                 brand = 'Pegassi',         price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'tropic',        name = 'Tropic',                        brand = 'Shitzu',          price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'tropic2',       name = 'Tropic Yacht',                  brand = 'Shitzu',          price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'suntrap',       name = 'Suntrap',                       brand = 'Shitzu',          price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'submersible',   name = 'Submersible',                   brand = 'Kraken Subs',     price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'none' },
    { model = 'squalo',        name = 'Squalo',                        brand = 'Shitzu',          price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'seashark',      name = 'Seashark',                      brand = 'Speedophile',     price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'seashark3',     name = 'Seashark Yacht',                brand = 'Speedophile',     price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'marquis',       name = 'Marquis',                       brand = 'Dinka',           price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'jetmax',        name = 'Jetmax',                        brand = 'Shitzu',          price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'dinghy',        name = 'Dinghy 2-Seater',               brand = 'Nagasaki',        price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'dinghy2',       name = 'Dinghy 4-Seater',               brand = 'Nagasaki',        price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'dinghy3',       name = 'Dinghy (Heist)',                brand = 'Nagasaki',        price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'none' },
    { model = 'dinghy4',       name = 'Dinghy Yacht',                  brand = 'Nagasaki',        price = BOAT_PRICE+40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    --- Helicopters (15)
    { model = 'conada2',       name = 'Weaponized Conada',             brand = 'Buckingham',      price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'none' },
    { model = 'conada',        name = 'Conada',                        brand = 'Buckingham',      price = HELICOPTER_PRICE+115000,  category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'seasparrow2',   name = 'Sparrow',                       brand = 'Unknown',         price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'annihilator2',  name = 'Annihilator Stealth',           brand = 'Western Company', price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'none' },
    { model = 'seasparrow',    name = 'Sea Sparrow',                   brand = 'Unknown',         price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'akula',         name = 'Akula',                         brand = 'Unknown',         price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'none' },
    { model = 'hunter',        name = 'FH-1 Hunter',                   brand = 'Unknown',         price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'none' },
    { model = 'havok',         name = 'Havok',                         brand = 'Nagasaki',        price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'volatus',       name = 'Volatus',                       brand = 'Buckingham',      price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'supervolito2',  name = 'SuperVolito Carbon',            brand = 'Buckingham',      price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'supervolito',   name = 'SuperVolito',                   brand = 'Buckingham',      price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'swift2',        name = 'Swift Deluxe',                  brand = 'Buckingham',      price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'valkyrie',      name = 'Valkyrie',                      brand = 'Buckingham',      price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'none' },
    { model = 'savage',        name = 'Savage',                        brand = 'Unknown',         price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'none' },
    { model = 'swift',         name = 'Swift',                         brand = 'Buckingham',      price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'annihilator',   name = 'Annihilator',                   brand = 'Western Company', price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'none' },
    { model = 'cargobob2',     name = 'Cargobob Jetsam',               brand = 'Western Company', price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'none' },
    { model = 'skylift',       name = 'Skylift',                       brand = 'HVY',             price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'none' },
    { model = 'maverick',      name = 'Maverick',                      brand = 'Buckingham',      price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'frogger',       name = 'Frogger',                       brand = 'Maibatsu',        price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'frogger2',      name = 'Frogger',                       brand = 'Maibatsu',        price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'cargobob',      name = 'Cargobob',                      brand = 'Western Company', price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'none' },
    { model = 'cargobob3',     name = 'Cargobob',                      brand = 'Western Company', price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'none' },
    { model = 'seasparrow3',   name = 'Sparrow (Prop)',                brand = 'Unknown',         price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'none' },
    { model = 'buzzard',       name = 'Buzzard Attack Chopper',        brand = 'Nagasaki',        price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'none' },
    { model = 'buzzard2',      name = 'Buzzard',                       brand = 'Nagasaki',        price = HELICOPTER_PRICE+52000,   category = 'helicopters',    type = 'heli',       shop = 'none' },
    --- Planes (16)
    { model = 'streamer216',   name = 'Streamer216',                   brand = 'Mammoth',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'raiju',         name = 'F-160 Raiju',                   brand = 'Mammoth',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'alkonost',      name = 'RO-86 Alkonost',                brand = 'Unknown',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'strikeforce',   name = 'B-11 Strikeforce',              brand = 'Unknown',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'blimp3',        name = 'Blimp',                         brand = 'Unknown',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'avenger',       name = 'Avenger',                       brand = 'Mammoth',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'avenger2',      name = 'Avenger',                       brand = 'Mammoth',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'volatol',       name = 'Volatol',                       brand = 'Unknown',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'nokota',        name = 'P-45 Nokota',                   brand = 'Unknown',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'seabreeze',     name = 'Seabreeze',                     brand = 'Western Company', price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'pyro',          name = 'Pyro',                          brand = 'Buckingham',      price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'mogul',         name = 'Mogul',                         brand = 'Mammoth',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'howard',        name = 'Howard NX-25',                  brand = 'Unknown',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'bombushka',     name = 'RM-10 Bombushka',               brand = 'Unknown',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'molotok',       name = 'V-65 Molotok',                  brand = 'Unknown',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'microlight',    name = 'Ultralight',                    brand = 'Unknown',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'tula',          name = 'Tula',                          brand = 'Mammoth',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'rogue',         name = 'Rogue',                         brand = 'Western Company', price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'starling',      name = 'LF-22 Starling',                brand = 'Unknown',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'alphaz1',       name = 'Alpha-Z1',                      brand = 'Buckingham',      price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'nimbus',        name = 'Nimbus',                        brand = 'Buckingham',      price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'luxor2',        name = 'Luxor Deluxe',                  brand = 'Buckingham',      price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'velum2',        name = 'Velum 5-seater',                brand = 'JoBuilt',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'hydra',         name = 'Hydra',                         brand = 'Mammoth',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'blimp2',        name = 'Xero Blimp',                    brand = 'Unknown',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'dodo',          name = 'Dodo',                          brand = 'Mammoth',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    ...
    { model = 'cargoplane',    name = 'Cargo Plane',                   brand = 'JoBuilt',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' }, -- so biiiiiiiiiig
    ...
    { model = 'lazer',         name = 'P-996 Lazer',                   brand = 'JoBuilt',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'mammatus',      name = 'Mammatus',                      brand = 'JoBuilt',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'stunt',         name = 'Mallard',                       brand = 'Western Company', price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'luxor',         name = 'Luxor',                         brand = 'Buckingham',      price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'jet',           name = 'Jet',                           brand = 'Unknown',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    { model = 'duster',        name = 'Duster',                        brand = 'Western Company', price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'cuban800',      name = 'Cuban 800',                     brand = 'Western Company', price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'blimp',         name = 'Atomic Blimp',                  brand = 'Unknown',         price = PLANE_PRICE+45000,   category = 'planes',         type = 'plane',      shop = 'none' },
    --- Service (17)
