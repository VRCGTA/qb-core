...
QBShared.Items = {
	...
	--Performance
	["turbo"] =             {["name"] = "turbo",            ["label"] = "Supercharger Turbo",	["weight"] = 0, ["type"] = "item",  ["image"] = "turbo.png",            ["unique"] = false,  ["useable"] = true, ["shouldClose"] = true, ["description"] = "Who doesn't need a 65mm Turbo??"},
    ...
    --skateboard
    ['skateboard'] = {['name'] = 'skateboard', ['label'] = 'Skateboard', ['weight'] = 1000, ['type'] = 'item', ['image'] = 'skateboard.png', ['unique'] = false, ['useable'] = true, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Be like a Tony Hawk'},
    ...
    -- Airsofts
    weapon_airsoftglock20                = { name = 'weapon_airsoftglock20', label = 'Airsoft Glock20', weight = 1000, type = 'weapon', ammotype = 'AMMO_SMG', image = 'WEAPON_AIRSOFTGLOCK20.png', unique = true, useable = false, description = 'A small firearm designed to be held in one hand' },
    weapon_airsoftak47         = { name = 'weapon_airsoftak47', label = 'Airsoft AK47', weight = 1000, type = 'weapon', ammotype = 'AMMO_SMG', image = 'WEAPON_AIRSOFTAK47.png', unique = true, useable = false, description = 'A rapid-fire, magazine-fed automatic rifle designed for infantry use' },
    weapon_airsoftm4         = { name = 'weapon_airsoftm4', label = 'Airsoft M4', weight = 1000, type = 'weapon', ammotype = 'AMMO_SMG', image = 'WEAPON_AIRSOFTM4.png', unique = true, useable = false, description = 'A rapid-fire, magazine-fed automatic rifle designed for infantry use' },
    weapon_airsoftm249         = { name = 'weapon_airsoftm249', label = 'Airsoft M249', weight = 1000, type = 'weapon', ammotype = 'AMMO_SMG', image = 'WEAPON_AIRSOFTM249.png', unique = true, useable = false, description = 'A combat version of an automatic gun that fires bullets in rapid succession for as long as the trigger is pressed' },
    weapon_airsoftg36c         = { name = 'weapon_airsoftg36c', label = 'Airsoft G36C', weight = 1000, type = 'weapon', ammotype = 'AMMO_SMG', image = 'WEAPON_AIRSOFTG36C.png', unique = true, useable = false, description = 'A handheld light weight machine gun' },
    weapon_airsoftmp5         = { name = 'weapon_airsoftmp5', label = 'Airsoft MP5', weight = 1000, type = 'weapon', ammotype = 'AMMO_SMG', image = 'WEAPON_AIRSOFTMP5.png', unique = true, useable = false, description = 'A handheld light weight machine gun' },
    weapon_airsoftmicrouzi         = { name = 'weapon_airsoftmicrouzi', label = 'Airsoft MicroUzi', weight = 1000, type = 'weapon', ammotype = 'AMMO_SMG', image = 'airsoftmicrouzi.png', unique = true, useable = false, description = 'A handheld light weight machine gun' },
    weapon_airsoftr700         = { name = 'weapon_airsoftr700', label = 'Airsoft R700', weight = 1000, type = 'weapon', ammotype = 'AMMO_SMG', image = 'WEAPON_AIRSOFTR700.png', unique = true, useable = false, description = 'Shotgun ?' },
    weapon_airsoftr870      = { name = 'weapon_airsoftr870', label = 'Airsoft R870', weight = 1000, type = 'weapon', ammotype = 'AMMO_SMG', image = 'WEAPON_AIRSOFTR870.png', unique = true, useable = false, description = 'Shotgun ?' },
    bbammo                  = { name = 'bbammo', label = 'BBs', weight = 200, type = 'item', image = 'airsoft_ammo.png', unique = false, useable = true, shouldClose = true, combinable = nil, description = 'Ammo for Airsoft' },
